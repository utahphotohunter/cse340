...
ALTER TYPE public.account_type OWNER TO mitch48875;
...
CREATE TABLE IF NOT EXISTS public.inventory (
    ...
    inv_year characyter(4) NOT NULL,
...
-- Create relationship between 'classication' and 'inventory' tables
ALTER TABLE IF EXISTS public.inventory
	ADD CONSTRAINT fk_classification FOREIGN KEY (classification_id)
	REFERENCES public.classfication (classification_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;
